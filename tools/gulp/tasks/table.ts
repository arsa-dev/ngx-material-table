...
/** Path to tsconfig file for the ngx-material-table. */
...
/** Builds components for ngx-material-table releases */
...
/** Creates a rollup bundles of the ngx-material-table components.*/
